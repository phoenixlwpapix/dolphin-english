                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex flex-wrap items-center gap-3">
                                            ...
                                            {isJoined && (
                                                <span className="px-3 py-1.5 rounded-md text-sm font-medium bg-white/20 text-white border border-white/30 flex items-center gap-1.5 backdrop-blur-sm">
                                    ...
                                    {pathData.courses.map((course, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${cDiffConfig?.color ?? "text-gray-500"}`}>
                                                    {course.difficulty}
                                                </span>
                                            </div>
                                        );
                            ...
                            <div className="pt-6 border-t border-border/50">
                                <div className="flex justify-center">
                                    {!currentUser ? (
                                        ...
                                        <Button size="lg" onClick={() => router.push(`/path/${pathId}`)}>
