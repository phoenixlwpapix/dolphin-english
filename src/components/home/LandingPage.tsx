    ...
    return (
        <div className="flex flex-col min-h-[calc(100vh-80px)] bg-background overflow-hidden">
            ...
            <section className="relative px-4 pt-48 pb-24 md:pt-56 md:pb-36 overflow-hidden">
                ...
                <div className="absolute top-10 left-[10%] w-72 h-72 bg-primary-500/15 rounded-full blur-3xl animate-pulse-soft" />
                <div className="absolute top-40 right-[5%] w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-pulse-soft animation-delay-200" />
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-64 bg-primary-500/5 rounded-full blur-3xl" />

                {/* Floating decorative elements */}
                <div className="absolute top-20 left-[15%] hidden lg:block animate-float opacity-60">
                    <div className="w-16 h-16 rounded-2xl bg-accent shadow-lg shadow-accent/25 flex items-center justify-center text-white">
                        <GlobeIcon className="w-8 h-8" />
                    </div>
                </div>
                <div className="absolute top-32 right-[12%] hidden lg:block animate-float-slow opacity-60">
                    <div className="w-14 h-14 rounded-xl bg-primary-700 shadow-lg shadow-primary-700/25 flex items-center justify-center text-white">
                        <BookOpenIcon className="w-7 h-7" />
                    </div>
                </div>
                <div className="absolute bottom-32 left-[8%] hidden lg:block animate-float animation-delay-300 opacity-60">
                    <div className="w-12 h-12 rounded-lg bg-secondary shadow-lg shadow-secondary/25 flex items-center justify-center text-primary-900">
                ...
                <div className="container mx-auto text-center max-w-4xl relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-slide-up animation-delay-300">
                        <Button
                            size="xl"
                            className="w-full sm:w-auto text-lg px-10 py-7 rounded-2xl bg-accent hover:bg-accent-600 shadow-xl shadow-accent/25 hover:shadow-accent/40 transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5"
                            onClick={onStart}
                        >
                        ...
                        <Button
                            variant="outline"
                            size="xl"
                            className="w-full sm:w-auto text-lg px-10 py-7 rounded-2xl border-2 border-border hover:border-accent/50 hover:bg-accent/5 transition-all duration-300"
                            onClick={() => {
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {features.map((feature, index) => (
                            <div
                                key={feature.key}
                                className="group relative bg-card border border-border p-8 rounded-2xl hover:border-accent/40 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-accent/5"
                                style={{ animationDelay: `${index * 100}ms` }}
                            >
                                {/* Solid background on hover */}
                                <div className={`absolute inset-0 ${feature.cardBg} rounded-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-300`} />

                                <div className="relative z-10">
                                    {/* Icon with solid background */}
                                    <div className={`w-14 h-14 rounded-xl ${feature.iconBg} flex items-center justify-center mb-6 text-white shadow-lg transition-transform duration-300 group-hover:scale-110`}>
                                        {feature.icon}
                                    </div>
            ...
            <section className="py-24 px-4 relative overflow-hidden">
                ...
                <div className="container mx-auto max-w-3xl text-center relative z-10">
                    <div className="relative inline-block mb-8">
                        <QuoteIcon className="w-16 h-16 text-accent/20" />
            ...
            <section className="py-24 relative overflow-hidden">
                {/* Gradient background */}
                <div className="absolute inset-0 bg-primary-50 dark:bg-muted" />
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <Button
                            size="xl"
                            className="text-lg px-12 py-7 rounded-2xl bg-accent hover:bg-accent-600 shadow-xl shadow-accent/25 hover:shadow-accent/40 transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5"
                            onClick={onStart}
                        >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
                    ...
                    <div className="col-span-2 lg:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-8 h-8 rounded-full bg-muted/50 flex items-center justify-center text-muted-foreground hover:bg-accent/10 hover:text-accent transition-all duration-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.features}</a></li>
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.pricing}</a></li>
                            <li><a href="#" className="hover:text-accent transition-colors">{t.landing.stats.ai}</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.blog}</a></li>
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.community}</a></li>
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.help}</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.about}</a></li>
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.careers}</a></li>
                            <li><a href="#" className="hover:text-accent transition-colors">{t.footer.legal}</a></li>
                        </ul>
                    </div>
                </div>
