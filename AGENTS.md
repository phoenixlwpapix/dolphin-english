...
- **AI**: Google Gemini 3.5 Flash (via @ai-sdk/google) for article analysis, vocabulary quiz generation, and example sentence generation
...
2. Backend calls Google Gemini 3.5 Flash with structured prompt
